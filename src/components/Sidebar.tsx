        ...
        {currentUser ? (
          <div className="rounded-xl bg-white/10 p-3">
            ...
            <button
              ...
              className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border border-white/15 bg-[#1b4662] px-3 py-2 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-[#163a52]"
            >
